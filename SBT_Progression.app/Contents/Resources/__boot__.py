...
_recipes_pil_prescript(['GifImagePlugin', 'SpiderImagePlugin', 'CurImagePlugin', 'XVThumbImagePlugin', 'FtexImagePlugin', 'XpmImagePlugin', 'IcoImagePlugin', 'IptcImagePlugin', 'XbmImagePlugin', 'McIdasImagePlugin', 'ImtImagePlugin', 'MicImagePlugin', 'JpegImagePlugin', 'MpoImagePlugin', 'Hdf5StubImagePlugin', 'PngImagePlugin', 'BmpImagePlugin', 'PsdImagePlugin', 'BufrStubImagePlugin', 'TiffImagePlugin', 'MspImagePlugin', 'MpegImagePlugin', 'IcnsImagePlugin', 'PcxImagePlugin', 'TgaImagePlugin', 'PcdImagePlugin', 'PpmImagePlugin', 'ImImagePlugin', 'PalmImagePlugin', 'SunImagePlugin', 'BlpImagePlugin', 'GbrImagePlugin', 'WmfImagePlugin', 'DdsImagePlugin', 'Jpeg2KImagePlugin', 'PdfImagePlugin', 'DcxImagePlugin', 'SgiImagePlugin', 'PixarImagePlugin', 'GribStubImagePlugin', 'FliImagePlugin', 'FitsStubImagePlugin', 'WebPImagePlugin', 'FpxImagePlugin', 'EpsImagePlugin'])
...
DEFAULT_SCRIPT='SBT_Progression.py'
SCRIPT_MAP={}
_run()
